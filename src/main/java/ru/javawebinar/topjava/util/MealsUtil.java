...
public class MealsUtil {
    private static int MEAL_ID = START_SEQ + 2;
    ...
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(MEAL_ID++, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000),
            new Meal(MEAL_ID++, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
